...
<div class="album px-5">
    ...
    <div id="form-add-container" style="display: none;">
        <form method="POST">
            ...
            <div class="form-group row mb-1">
                <label for="spotify" class="col-sm-2 col-form-label">Spotify:</label>
                <div class="col-sm-10">
            ...
            <form method="POST">
                ...
                <div class="form-group row mb-1">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" id="changedLogo" name="changedLogo" value="<?= (int)$updateArtist->getLogo() ?>" required>
                    </div>
                </div>
                <div class="form-group row mb-1">
                ...
                <div class="form-group row mb-1">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text" class="form-control" id="changedImage" name="changedImage" value="<?= (int)$updateArtist->getImage() ?>" required>
                    </div>
                </div>
